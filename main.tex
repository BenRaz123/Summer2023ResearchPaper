...
\newfontfamily\headingfont{Nexus Serif Pro}[Numbers=Lining]
...
\begin{axis}[
        ...
        \addplot[draw=none,fill=white!20!green!80!blue] coordinates {(C++, 53) (Rust, 41) (Java, 36) (JavaScript, 35) (Python, 26)};
\end{axis}
\end{tikzpicture}
\end{adjustbox}
\end{center}
